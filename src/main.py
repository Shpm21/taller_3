...
def combate_jugadores(creatura_usuario: Creatura, creatura_oponente: Creatura) -> bool:
    print(f'Creaturas en combate: {creatura_usuario.especie.nombre_especie} PS: {creatura_usuario.salud} vs {creatura_oponente.especie.nombre_especie} PS: {creatura_oponente.salud}')
...
def lucha(usuario: Usuario):
    ...
    print(cantidad_minima(cantidad_c_u, cantidad_c_o))
...
def equipo_lucha(usuario: Usuario):
    ...
    if equipo:
        ...
        print('El jugador no tiene creaturas capturadas')
...
def creatudex(usuario: Usuario):
    ...
    print(f'La cantidad de especies que ha capturado hasta el momento es de {connect.obtener_cantidad_creatudex(usuario)}')
    print(f'La cantidad de especies que nos falta por descubrir es de: {connect.obtener_cantidad_especies()}')
